...
import { useAddEmployee } from '../lib/ReactQuery'
...
const NewForm: React.FC = () => {
  ...
  const handleNewEmployee = async (formData: FormData) => {
  ...
  return (
    <form onSubmit={handleSubmit(handleNewEmployee)} className="inline-flex justify-center w-full pb-10 max-w-3xl">
